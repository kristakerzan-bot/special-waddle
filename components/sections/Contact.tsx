    ...
    <section id="resolution" className="py-24 md:py-32">
      <Container className="flex flex-col items-center gap-12 text-center">
        ...
        <a
          ...
          className="group mt-4 flex items-center gap-6 rounded-full border-2 border-white px-10 py-6 font-sans text-sm font-bold uppercase tracking-[0.2em] text-text-primary transition-colors hover:bg-white hover:text-bg"
        >
