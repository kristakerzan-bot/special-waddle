...
const ROLES = [
  {
    ...
    badge: "30 → 450+ Growth",
    active: true,
    body: "Owning the experience layer across 11 product domains. Led end-to-end UX research through interviews, surveys, and usability testing to validate every major pattern before it shipped, built and maintain the platform's design system under strict regulatory constraints, and partnered directly with engineering, compliance, and stakeholders to turn findings into production-ready prototypes.",
  },
  {
